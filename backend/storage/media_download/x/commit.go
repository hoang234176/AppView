...
// commitXMedia safely moves downloaded items to destination and emits folder invalidations.
func commitXMedia(ctx context.Context, job *Job, workspace string) error {
	job.mu.RLock()
	...
	// Multiple items (photos, post text, videos): copy each file directly into destinationPath without creating a subfolder
...
// commitMediaFile safely copies a file directly to destination without creating a subfolder.
