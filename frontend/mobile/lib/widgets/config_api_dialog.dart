...
class _ConfigApiDialogState extends State<ConfigApiDialog> {
  ...
  Future<void> _handleSaveServer() async {
    ...
    if (ip.isEmpty || port.isEmpty || rootPath.isEmpty) {
      setState(() {
        _errorMessage = 'Vui lòng nhập đầy đủ tất cả các trường: IP, Cổng và Đường dẫn thư mục gốc.';
      });
      return;
    }
    ...
    if (success) {
      ...
      AppToast.showSuccess(
        context,
        'Đã lưu kết nối máy chủ: $ip:$port',
      );
    }
  }
  ...
  Future<void> _handleClearCache() async {
    ...
    if (res.success) {
      ...
      final err = res.message.isNotEmpty ? res.message : 'Không thể dọn dẹp cache!';
  ...
  Widget build(BuildContext context) {
    ...
    final isServerConnected = appState.errorInfo == null &&
    ...
    final Widget serverStatusTrailing = Container(
      ...
      decoration: BoxDecoration(
        color: isServerConnected ? Colors.green.withValues(alpha: 0.15) : Colors.red.withValues(alpha: 0.15),
          ...
          children: [
            ...
            Row(
              ...
              children: [
                const Row(
                  children: [
                    Icon(Icons.settings_suggest_rounded, color: AppTheme.googleBlue, size: 24),
                    SizedBox(width: 10),
                    Text(
                      'Cài đặt Hệ Thống',
                      style: TextStyle(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildAccordionSection(
                      ...
                      onToggle: () => setState(() => _openSection1 = !_openSection1),
                        ...
                        children: [
                              ...
                              Expanded(
                                ...
                                child: Padding(
                                  ...
                                  child: TextField(
                                    ...
                                    style: TextStyle(
                                      fontSize: _ipController.text.isNotEmpty ? 13.5 : 12,
                                      color: Colors.white,
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      floatingLabelStyle: const TextStyle(fontSize: 14, color: AppTheme.googleBlue, fontWeight: FontWeight.bold),
                                      floatingLabelBehavior: FloatingLabelBehavior.auto,
                                      hintText: '192.168.1.xxx',
                                      hintStyle: TextStyle(fontSize: 10, color: Colors.white.withValues(alpha: 0.2)),
                                      prefixIcon: const Icon(Icons.lan_rounded, color: AppTheme.googleBlue, size: 16),
                              ...
                              Expanded(
                                ...
                                child: Padding(
                                  ...
                                  child: TextField(
                                    ...
                                    onChanged: (_) => setState(() {}),
                                    style: TextStyle(
                                      fontSize: _portController.text.isNotEmpty ? 13.5 : 12,
                                      color: Colors.white,
                                      fontFamily: 'monospace',
                                    ),
                                    decoration: InputDecoration(
                          ...
                          Padding(
                            ...
                            child: TextField(
                              ...
                              onChanged: (_) => setState(() {}),
                              style: TextStyle(
                                fontSize: _rootPathController.text.isNotEmpty ? 13.5 : 12,
                                color: Colors.white,
                                fontFamily: 'monospace',
                              ),
                              decoration: InputDecoration(
                                ...
                                labelStyle: const TextStyle(fontSize: 11, color: Colors.white70),
                                floatingLabelStyle: const TextStyle(fontSize: 14, color: AppTheme.folderYellow, fontWeight: FontWeight.bold),
                                floatingLabelBehavior: FloatingLabelBehavior.auto,
                                hintText: '/Volumes/HDD/Albums',
                                hintStyle: TextStyle(fontSize: 10, color: Colors.white.withValues(alpha: 0.2)),
                                prefixIcon: const Icon(Icons.folder_open_rounded, color: AppTheme.folderYellow, size: 16),
                                contentPadding: const EdgeInsets.symmetric(horizontal: 12, vertical: 10),
                                isDense: true,
                                border: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(10),
                                ...
                                focusedBorder: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(10),
                                  borderSide: const BorderSide(color: AppTheme.folderYellow),
                                ),
                              ),
                            ),
                          ),
                          ...
                          Align(
                            ...
                            child: ElevatedButton.icon(
                              onPressed: _isSavingServer ? null : _handleSaveServer,
                              icon: _isSavingServer
                                  ? const SizedBox(width: 14, height: 14, child: CircularProgressIndicator(strokeWidth: 2, color: Colors.white))
                                  : const Icon(Icons.save_rounded, size: 14),
                              label: const Text('Lưu Máy chủ', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                    ...
                    _buildAccordionSection(
                      ...
                      onToggle: () => setState(() => _openSection2 = !_openSection2),
                        ...
                        children: [
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  children: [
                                    const Icon(Icons.memory_rounded, size: 16, color: Colors.amberAccent),
                          ...
                          if (_cacheMsg != null) ...[
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  Icon(
                                    _cacheMsg!.contains('không') || _cacheMsg!.contains('Lỗi')
                                        ? Icons.error_outline_rounded
                                        : Icons.check_circle_rounded,
                                    size: 16,
                                    color: _cacheMsg!.contains('không') || _cacheMsg!.contains('Lỗi')
                                        ? Colors.redAccent
                                        : Colors.greenAccent,
                                  ),
                                  const SizedBox(width: 6),
                          ...
                          Align(
                            ...
                            child: ElevatedButton.icon(
                              ...
                              label: const Text('Dọn dẹp Cache', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                              style: ElevatedButton.styleFrom(
