...
class _LightboxScreenState extends State<LightboxScreen> {
  ...
  void _onPageChanged(int index) {
    ...
    final list = appState.filteredPictures.isNotEmpty ? appState.filteredPictures : widget.pictures;
  ...
  Widget build(BuildContext context) {
    ...
    final picturesList = appState.filteredPictures.isNotEmpty ? appState.filteredPictures : widget.pictures;
    final totalCount = appState.totalPictures > 0 ? appState.totalPictures : picturesList.length;
    final currentPic = _currentIndex < picturesList.length ? picturesList[_currentIndex] : widget.pictures[_currentIndex];
              ...
              children: [
                ...
                builder: (context, index) {
                  ...
                  return PhotoViewGalleryPageOptions.customChild(
                    ...
                    heroAttributes: PhotoViewHeroAttributes(tag: pic.path.isNotEmpty ? pic.path : '$index'),
                        ...
                        errorWidget: (context, url, error) => const Center(
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 8),
                              Text('Không thể tải ảnh gốc', style: TextStyle(color: Colors.grey, fontSize: 14)),
                            ],
                          ),
                        ),
                      ),
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: AppTheme.googleBlue.withValues(alpha: 0.4)),
                        ),
                        child: Text(
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  const Icon(Icons.calendar_today_rounded, size: 13, color: AppTheme.googleBlue),
                                  const SizedBox(width: 6),
                                  Text(
                                    Formatters.formatDate(currentPic.modTime),
                                    style: const TextStyle(fontSize: 14, color: Color(0xFFE8EAED)),
                                  ),
                                ],
                              ),
                              ...
                              Row(
                                children: [
                                  const Icon(Icons.folder_rounded, size: 13, color: AppTheme.folderYellow),
                                  const SizedBox(width: 6),
                                  Expanded(
                                    child: Text(
                                      currentPic.path,
                        ...
                        children: [
                          ...
                          IconButton(
                            ...
                            icon: Icon(
                              ...
                              color: _isPlaying ? AppTheme.googleBlue : Colors.white,
                              size: 22,
                            ),
                            style: IconButton.styleFrom(
                            ...
                            tooltip: _isPlaying ? 'Tạm dừng chiếu' : 'Trình chiếu',
                          ),
                          const SizedBox(width: 8),
                          ...
                          IconButton(
                            ...
                            icon: const Icon(Icons.restart_alt_rounded, color: Color(0xFFFDE047), size: 22),
                            style: IconButton.styleFrom(
                              backgroundColor: Colors.white.withValues(alpha: 0.1),
                            ),
                          ...
                          IconButton(
                            ...
                            icon: Icon(
                              ...
                              color: _showInfo ? AppTheme.googleBlue : Colors.white,
                              size: 22,
                            ),
                            style: IconButton.styleFrom(
